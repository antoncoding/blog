  ...
  return (
    <Link href={`/${data.slug}`}>
      <a>
        <article
          key={data.id}
          className="relative overflow-hidden mb-6 md:mb-8 rounded-xl bg-white dark:bg-zinc-700 hover:shadow-lg transition-shadow "
        >
          {category && (
          ...
          {data.thumbnail && (
            <div className="relative rounded-xl pb-[66%] lg:pb-[50%] bg-gray-200 dark:bg-zinc-700 ">
              <Image
                src={data.thumbnail}
